      ...
      <div class="acomod--item1--group">
        ...
        <div class="acomod--item1---columnr">
          ...
          <div class="acomod--item1---columnr_info">
            ...
            <button class="addServices services-buy--s">
              Serviços adicionais
            </button>
          </div>
        </div>
        ...
        <div class="acomod--item1---columnc----2">
          <div class="acomod--item1---columnc----2_group1">
            <p class="qtdRoomP">
              ...
              <button class="addRoomS addRoom">+</button>
              <span class="qtdRoomS">0</span>
              <button class="remRoomS remRoom">-</button>
            </p>

            <P>Diária por pessoa</P>
            <p>
              <s> R$ </s><s class="priceDesc--s price">{{previousPrice}}</s> Por
              <b class="price--s price">{{priceOfficial}}</b>
            </p>
            <p>Impostos e Taxas inclusos</p>
          </div>
          <div class="acomod--item1---columnc----2_group2">
            <button class="acomod-buy acomod-buy--s">Escolher</button>
          </div>
        </div>
      </div>
    </div>
